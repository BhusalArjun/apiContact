...
public class UserService {
	...
	public UserResponseDto addUser(UserCreateDto request) {
		...
		List<ContactDto> contactRequests = request.getContactDtos();
...
//			Contact contact = new Contact();
//			contact.setEmail(contacts.get(i).getEmail());
//			contact.setMobileNumber(contacts.get(i).getMobileNumber());
//			contact.setUser(user);
//			contactRepository.save(contact);
//		}
	}
	...
	private UserResponseDto getUserResponseDto(User savedUser) {
		...
		response.setContactDtos(contactDtoList);
	...
	public User update(Long id, UserUpdateDto request) {
		...
		if (optional.isPresent()) {
			...
			updateContacts(request.getContacts());
